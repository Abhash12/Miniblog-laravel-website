                                        ...
                                        <tbody class="bg-gray-600 text-white divide-y divide-gray-500">
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                                    ...
                                                    <a href="{{url('/post/delete', $post->id)}}" class="bg-red-500 hover:bg-red-400 focus:shadow-outline focus: outline-none text-white text-sm py-1 px-2 rounded">Delete</a>
                                                </td>
                                            </tr>
